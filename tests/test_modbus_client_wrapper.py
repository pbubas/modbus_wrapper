import unittest
from modbus_client_wrapper import ModbusClientWrapper, ModbusFunctionArgument, get_modbus_object


class TestModbusClientWrapper:

    class TestCreateReads(unittest.TestCase):
        modbus_objects =  [
            get_modbus_object(1),
        ...
        def test_max_read_size(self):
            ...
            result = ModbusClientWrapper._get_modbus_function_args(modbus_objects, max_read_size=5)
            assert result == [
            ...
            result = ModbusClientWrapper._get_modbus_function_args(modbus_objects, max_read_size=1)
            assert result == [
